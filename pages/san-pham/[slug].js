...
const Product = (props) => {
  ...
  console.log("detailMainCategory: ", detailMainCategory);
  // state for compute
          ...
          <Row>
            <Col>
              <Breadcrumb className="product__breadcrumb">
                ...
                <Breadcrumb.Item href={`/danh-muc/${detailMainCategory.slug}`}>
                  {detailMainCategory.name}
                </Breadcrumb.Item>
                <Breadcrumb.Item href={`/danh-muc/${detailCategory.slug}`}>
                  {detailCategory.name}
                </Breadcrumb.Item>
          ...
          <Row className="product__detail">
                ...
                <Tabs>
                  ...
                  <TabPanel>
                    ...
                    <span style={{ fontStyle: "italic" }}>
                      (Với mỗi bộ rèm nhỏ hơn 01 m² được tính tròn 01 m², chiều
                      cao dưới 01 mét được tính tròn 01 mét).
                    </span>

                    <div style={{ marginTop: "35px" }}>
                      <span>
                        <strong>Rèm Vương Hồng</strong> mang đến cho quý khách
                        các <strong>dịch vụ ưu đãi </strong> như:
                      </span>
                    </div>
                    <ul
                    ...
                    >
                      <li style={{ marginTop: "10px" }}>
                        <strong>Vận chuyển:</strong> Miễn phí vận chuyển và lắp
                        đặt trong thành phố Hà Nội với đơn hàng trên 05m2, đơn
                        hàng dưới 05m2 phụ thu thêm 100.000đ/đơn hàng.
                      </li>
                      <li style={{ marginTop: "10px" }}>
                        <strong>Khuyến mại:</strong> Phụ kiện cơ bản (Bao gồm
                        khóa chiều cao và chống kéo ngược).
                      </li>
                    </ul>
                  </TabPanel>
                  <TabPanel>
            ...
            <Col xs={12} md={4} className="product__detail-box">
              <div style={{ position: "sticky", top: "160px" }}>
                ...
                <div className="product__detail-status">Còn hàng</div>
                ...
                {detailProduct.unit_cost && (
                  ...
                  >
                    {detailProduct.unit_cost}.000đ/m2
                  </div>
                )}

                <div className="product__compute-header">Báo giá sơ bộ</div>
                ...
                <Row className="product__compute">
                  <Col xs={6} className="product__compute-item">
                    ...
                    <input
                      ...
                      className="product__compute-item-input"
                  ...
                  <Col xs={6} className="product__compute-item">
                    <div className="product__compute-item-title">Số bộ</div>
                    <input
                      type="number"
                      value={count}
                      onChange={(e) => {
                ...
                <Row className="product__compute-result">
                  ...
                  <Col xs={6} className="product__compute-result-price">
                    <div className="product__compute-result-price-box">
...
export async function getServerSideProps(context) {
  ...
  detailMainCategory = await categoryService.detailMainCategoryById(
    detailProduct.data.main_category_id
  );
  ...
  relatedProducts.data.listProductReturn =
    relatedProducts.data.listProductReturn.filter(
      (product) => product.id !== detailProduct.data.id
    );
  return {
    props: {
