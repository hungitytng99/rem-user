...
export default function slugTuVan({ gocTuVan, detailPost, baiLienQuan }) {
    return (
        <>
            <Head>
                <title>Tư vấn</title>
                ...
                <div className="cong_trinh">
                    ...
                    <Row>
                        ...
                        <Col lg={3} className="news_recently">
                            ...
                            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FVuongHongManhRem%2F&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=1167378840265020" width="340" height="500" style={{ border: "none", overflow: "hidden" }} scrolling="no" frameBorder="0" allowFullScreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
...
export async function getServerSideProps(context) {
    ...
    try {
        ...
        const baiLienQuan = await postService.listPostByTagId(10, { postsPerPage: 6, pageNumber: 1 });
