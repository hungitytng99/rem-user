            ...
            <div className="layout__content" >
                ...
                <Container>
                    <div style={{ marginTop: '40px', padding: '0px 30px' }}>
                        ...
                        <p style={{ textIndent: '30px' }}>Chất lượng sản phẩm luôn là vấn đề được RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG quan tâm hàng đầu, vì vậy tất cả linh kiện và nguyên liệu nhập từ nước ngoài hoặc trong nước đều được chúng tôi chọn lọc kỹ.Sản phẩm sau khi sản xuất đều thông qua bộ phận kiểm đinh.Kiểm tra chất lượng trước khi xuất hàng.</p>
                        <p style={{ textIndent: '30px' }}>RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG đã không ngừng câp nhật những kỹ thuật mới trong sản xuất cũng như đầu tư mới các trang thiết bị sản xuất tiên tiến để tạo ra các sản phẩm mang phong cách hiện đại và thẩm mỹ đáp ứng nhu cầu đòi hỏi ngày càng cao của người tiêu dùng.</p>
                        <p>Tất cả các sản phẩm tại RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG đều phải có tất cả các tiêu chí: </p>
                        <ul>
                        ...
                        <p>RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG sự lựa chọn hoàn hảo của bạn!</p>

                        <p>Quan Điểm Kinh Doanh.</p>
                        <ul>
                            <li>
                                - Cung cấp những sản phẩm tốt với giá cả cạnh tranh nhất đi kèm với dịch vụ hoàn hảo là những gì RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG sẽ đem đến cho khách hàng.
                            </li>
                            <li>
                                - Luôn đặt chữ “TÍN” lên hàng đầu.
                            </li>
                            <li>
                                - Tâm niệm làm hài lòng cho mọi khách hàng là tiêu chí hàng đầu RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG luôn đặt phương châm và tôn chỉ: &quot;khách hàng là trên hết - chất lượng mãi là hàng đầu&quot;
                            </li>
                            <li>
                                - Sự hài lòng của khách hàng là thành công của chúng tôi.
                            </li>
                            <li>
                                - RÈM CỬA BẮC NINH - RÈM VƯƠNG HỒNG luôn hoán vị mình vào địa vị của khách hàng để có những chính sách tốt nhất.
                            </li>
                        </ul>
